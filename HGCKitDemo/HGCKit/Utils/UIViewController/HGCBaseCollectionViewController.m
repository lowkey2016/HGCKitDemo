//
//  HGCBaseCollectionViewController.m
//  H5GameCenter
//
...
#import "HGCBaseCollectionViewController.h"
#import "MJRefresh.h"
...
@interface HGCBaseCollectionViewController ()

@end

@implementation HGCBaseCollectionViewController
...
- (void)setLeftItemType:(HGCBaseCollectionLeftItemType)leftItemType backgroundImage:(UIImage *)bgImg {
    ...
    if (leftItemType == HGCBaseCollectionLeftItemTypeNone) {
        return;
    }
    else if (leftItemType == HGCBaseCollectionLeftItemTypePop) {
        [_leftBarButtonItem addTarget:self action:@selector(popAction:) forControlEvents:UIControlEventTouchUpInside];
    }
    else if (leftItemType == HGCBaseCollectionLeftItemTypeDismiss) {
...
- (void)setLeftItemType:(HGCBaseCollectionLeftItemType)leftItemType {
