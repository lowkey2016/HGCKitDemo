...
@interface HGCMakeLayoutLinker ()

@end

@implementation HGCMakeLayoutLinker
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))leftTo {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView leftMargin:margin to:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))rightTo {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView rightMargin:margin to:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))topTo {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView topMargin:margin to:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))bottomTo {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView bottomMargin:margin to:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, UIEdgeInsets insets))edgeTo {
    return ^HGCLayoutLinker *(UIView *view, UIEdgeInsets insets) {
        [HGCMas view:self.srcView edgeInsets:insets to:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))centerXAlignTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView centerXAlignTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))centerYAlignTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView centerYAlignTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))centerAlignTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView centerAlignTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat xMargin, CGFloat yMargin))centerTo {
    return ^HGCLayoutLinker *(UIView *view, CGFloat xMargin, CGFloat yMargin) {
        [HGCMas view:self.srcView centerXOffset:xMargin centerYOffset:yMargin to:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(CGFloat value))widthIs {
    return ^HGCLayoutLinker *(CGFloat value) {
        [HGCMas view:self.srcView width:value];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(CGFloat value))widthGreaterThanOrIs {
    return ^HGCLayoutLinker *(CGFloat value) {
        [HGCMas view:self.srcView widthGreaterThanOrEqualTo:value];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(CGFloat value))widthLessThanOrIs {
    return ^HGCLayoutLinker *(CGFloat value) {
        [HGCMas view:self.srcView widthLessThanOrEqualTo:value];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))widthEqualTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView widthEqualToView:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))widthGreaterThanOrEqualTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView widthGreaterThanOrEqualToView:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))widthLessThanOrEqualTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView widthLessThanOrEqualToView:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat value))widthEqualToAdd {
    return ^HGCLayoutLinker *(UIView *view, CGFloat value) {
        [HGCMas view:self.srcView widthOffset:value compareTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat value))widthEqualToScale {
    return ^HGCLayoutLinker *(UIView *view, CGFloat value) {
        [HGCMas view:self.srcView widthScaleBy:value compareTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(CGFloat value))heightIs {
    return ^HGCLayoutLinker *(CGFloat value) {
        [HGCMas view:self.srcView height:value];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(CGFloat value))heightGreaterThanOrIs {
    return ^HGCLayoutLinker *(CGFloat value) {
        [HGCMas view:self.srcView heightGreaterThanOrEqualTo:value];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(CGFloat value))heightLessThanOrIs {
    return ^HGCLayoutLinker *(CGFloat value) {
        [HGCMas view:self.srcView heightLessThanOrEqualTo:value];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))heightEqualTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView heightEqualToView:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))heightGreaterThanOrEqualTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView heightGreaterThanOrEqualToView:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))heightLessThanOrEqualTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView heightLessThanOrEqualToView:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat value))heightEqualToAdd {
    return ^HGCLayoutLinker *(UIView *view, CGFloat value) {
        [HGCMas view:self.srcView heightOffset:value compareTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat value))heightEqualToScale {
    return ^HGCLayoutLinker *(UIView *view, CGFloat value) {
        [HGCMas view:self.srcView heightScaleBy:value compareTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(CGSize size))sizeIs {
    return ^HGCLayoutLinker *(CGSize size) {
        [HGCMas view:self.srcView size:size];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view))sizeEqualTo {
    return ^HGCLayoutLinker *(UIView *view) {
        [HGCMas view:self.srcView sizeEqualTo:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))leadingToRightOf {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView leading:margin toRightOf:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))trailingToLeftOf {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView trailing:margin toLeftOf:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))topSpacingToBottomOf {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView topSpacing:margin toBottomOf:view];
        return self;
    };
}
...
- (HGCLayoutLinker * (^)(UIView *view, CGFloat margin))bottomSpacingToTopOf {
    return ^HGCLayoutLinker *(UIView *view, CGFloat margin) {
        [HGCMas view:self.srcView bottomSpacing:margin toTopOf:view];
        return self;
    };
}
